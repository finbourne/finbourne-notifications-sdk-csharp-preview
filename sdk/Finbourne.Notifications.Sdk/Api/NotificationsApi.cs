...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface INotificationsApiSync : IApiAccessor
    {
        ...
        /// <param name="createAzureServiceBusNotification">The data to create an message sent to Azure Service              Bus</param>
        ...
        ApiResponse<Notification> CreateASBNotificationWithHttpInfo(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification);
        /// <summary>
        ...
        /// <param name="code">The code that identifies a notification</param>
        /// <param name="id">The unique identifier of the notification</param>
        /// <param name="updateAzureServiceBusNotification">The data to update a notification</param>
        /// <returns>Notification</returns>
        ...
        /// <param name="updateAzureServiceBusNotification">The data to update a notification</param>
        /// <returns>ApiResponse of Notification</returns>
        ApiResponse<Notification> UpdateAzureServiceBusNotificationWithHttpInfo(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification);
        /// <summary>
    ...
    public interface INotificationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Notification> CreateASBNotificationAsync(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Notification>> CreateASBNotificationWithHttpInfoAsync(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] CreateAwsSqsNotification: Add an AWS SQS notification to a subscription.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Notification</returns>
        System.Threading.Tasks.Task<Notification> UpdateAzureServiceBusNotificationAsync(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        System.Threading.Tasks.Task<ApiResponse<Notification>> UpdateAzureServiceBusNotificationWithHttpInfoAsync(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] UpdateEmailNotification: Update an email notification for a given subscription.
        /// </summary>
        /// <remarks>
    ...
    public partial class NotificationsApi : INotificationsApi
    {
        ...
        /// <param name="createAzureServiceBusNotification">The data to create an message sent to Azure Service              Bus</param>
        /// <returns>Notification</returns>
        public Notification CreateASBNotification(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification)
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> localVarResponse = CreateASBNotificationWithHttpInfo(scope, code, createAzureServiceBusNotification);
        ...
        /// <param name="createAzureServiceBusNotification">The data to create an message sent to Azure Service              Bus</param>
        /// <returns>ApiResponse of Notification</returns>
        public Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> CreateASBNotificationWithHttpInfo(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling NotificationsApi->CreateASBNotification");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling NotificationsApi->CreateASBNotification");

            // verify the required parameter 'createAzureServiceBusNotification' is set
            if (createAzureServiceBusNotification == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'createAzureServiceBusNotification' when calling NotificationsApi->CreateASBNotification");
            ...
            localVarRequestOptions.Data = createAzureServiceBusNotification;
            ...
            var localVarResponse = this.Client.Post<Notification>("/api/subscriptions/{scope}/{code}/notifications/asb", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CreateASBNotification", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Notification</returns>
        public async System.Threading.Tasks.Task<Notification> CreateASBNotificationAsync(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> localVarResponse = await CreateASBNotificationWithHttpInfoAsync(scope, code, createAzureServiceBusNotification, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Notifications.Sdk.Client.ApiResponse<Notification>> CreateASBNotificationWithHttpInfoAsync(string scope, string code, CreateAzureServiceBusNotification createAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling NotificationsApi->CreateASBNotification");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Notification>("/api/subscriptions/{scope}/{code}/notifications/asb", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="updateAzureServiceBusNotification">The data to update a notification</param>
        /// <returns>Notification</returns>
        public Notification UpdateAzureServiceBusNotification(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification)
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> localVarResponse = UpdateAzureServiceBusNotificationWithHttpInfo(scope, code, id, updateAzureServiceBusNotification);
            return localVarResponse.Data;
        }
        ...
        /// <param name="updateAzureServiceBusNotification">The data to update a notification</param>
        /// <returns>ApiResponse of Notification</returns>
        public Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> UpdateAzureServiceBusNotificationWithHttpInfo(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling NotificationsApi->UpdateAzureServiceBusNotification");

            // verify the required parameter 'code' is set
            if (code == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling NotificationsApi->UpdateAzureServiceBusNotification");

            // verify the required parameter 'id' is set
            if (id == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling NotificationsApi->UpdateAzureServiceBusNotification");

            // verify the required parameter 'updateAzureServiceBusNotification' is set
            if (updateAzureServiceBusNotification == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'updateAzureServiceBusNotification' when calling NotificationsApi->UpdateAzureServiceBusNotification");
            ...
            localVarRequestOptions.PathParameters.Add("code", Finbourne.Notifications.Sdk.Client.ClientUtils.ParameterToString(code)); // path parameter
            localVarRequestOptions.PathParameters.Add("id", Finbourne.Notifications.Sdk.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.Data = updateAzureServiceBusNotification;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Notification>("/api/subscriptions/{scope}/{code}/notifications/asb/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("UpdateAzureServiceBusNotification", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Notification</returns>
        public async System.Threading.Tasks.Task<Notification> UpdateAzureServiceBusNotificationAsync(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Notification> localVarResponse = await UpdateAzureServiceBusNotificationWithHttpInfoAsync(scope, code, id, updateAzureServiceBusNotification, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Notification)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Notifications.Sdk.Client.ApiResponse<Notification>> UpdateAzureServiceBusNotificationWithHttpInfoAsync(string scope, string code, string id, UpdateAzureServiceBusNotification updateAzureServiceBusNotification, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling NotificationsApi->UpdateAzureServiceBusNotification");
            ...
            var localVarResponse = await this.AsynchronousClient.PutAsync<Notification>("/api/subscriptions/{scope}/{code}/notifications/asb/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
