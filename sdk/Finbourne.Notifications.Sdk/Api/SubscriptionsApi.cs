...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface ISubscriptionsApiSync : IApiAccessor
    {
        ...
        ApiResponse<SubscriptionDetail> GetSubscriptionWithHttpInfo(string scope, string code);
        /// <summary>
        ...
        /// <param name="sortBy">Fields to order the result set. Read more about &lt;see href&#x3D;\&quot;https://support.lusid.com/filtering-results-from-lusid\&quot;&gt; filtering results from LUSID&lt;/see&gt;. (optional)</param>
    ...
    public interface ISubscriptionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SubscriptionDetail> GetSubscriptionAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SubscriptionDetail>> GetSubscriptionWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] ListSubscriptions: List subscriptions.
        /// </summary>
        /// <remarks>
    ...
    public partial class SubscriptionsApi : ISubscriptionsApi
    {
        ...
        public Finbourne.Notifications.Sdk.Client.ApiResponse<Subscription> CreateSubscriptionWithHttpInfo(CreateSubscription createSubscription)
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.1.228");
        ...
        /// <param name="code">The code that identifies a subscription</param>
        /// <returns>SubscriptionDetail</returns>
        public SubscriptionDetail GetSubscription(string scope, string code)
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<SubscriptionDetail> localVarResponse = GetSubscriptionWithHttpInfo(scope, code);
            return localVarResponse.Data;
        }
        ...
        /// <param name="code">The code that identifies a subscription</param>
        /// <returns>ApiResponse of SubscriptionDetail</returns>
        public Finbourne.Notifications.Sdk.Client.ApiResponse<SubscriptionDetail> GetSubscriptionWithHttpInfo(string scope, string code)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SubscriptionDetail>("/api/subscriptions/{scope}/{code}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SubscriptionDetail</returns>
        public async System.Threading.Tasks.Task<SubscriptionDetail> GetSubscriptionAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<SubscriptionDetail> localVarResponse = await GetSubscriptionWithHttpInfoAsync(scope, code, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SubscriptionDetail)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Notifications.Sdk.Client.ApiResponse<SubscriptionDetail>> GetSubscriptionWithHttpInfoAsync(string scope, string code, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling SubscriptionsApi->GetSubscription");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SubscriptionDetail>("/api/subscriptions/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
