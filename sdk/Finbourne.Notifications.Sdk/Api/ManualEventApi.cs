...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface IManualEventApiSync : IApiAccessor
    {
        ...
        /// <param name="body">The data required to trigger a manual event.</param>
        ...
        ApiResponse<ManualEvent> TriggerManualEventWithHttpInfo(Object body);
    ...
    public interface IManualEventApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ManualEvent> TriggerManualEventAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ManualEvent>> TriggerManualEventWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ManualEventApi : IManualEventApi
    {
        ...
        /// <param name="body">The data required to trigger a manual event.</param>
        /// <returns>ManualEvent</returns>
        public ManualEvent TriggerManualEvent(Object body)
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<ManualEvent> localVarResponse = TriggerManualEventWithHttpInfo(body);
        ...
        /// <param name="body">The data required to trigger a manual event.</param>
        /// <returns>ApiResponse of ManualEvent</returns>
        public Finbourne.Notifications.Sdk.Client.ApiResponse<ManualEvent> TriggerManualEventWithHttpInfo(Object body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling ManualEventApi->TriggerManualEvent");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ManualEvent</returns>
        public async System.Threading.Tasks.Task<ManualEvent> TriggerManualEventAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<ManualEvent> localVarResponse = await TriggerManualEventWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ManualEvent)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Notifications.Sdk.Client.ApiResponse<ManualEvent>> TriggerManualEventWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling ManualEventApi->TriggerManualEvent");
