...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface IDeliveriesApiSync : IApiAccessor
    {
        ...
        /// <param name="filter">Expression to filter the result set. Read more about &lt;see href&#x3D;\&quot;https://support.lusid.com/filtering-results-from-lusid\&quot; /&gt; filtering results from LUSID. (optional)</param>
