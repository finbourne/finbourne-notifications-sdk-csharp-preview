...
namespace Finbourne.Notifications.Sdk.Api
{
    ...
    public interface IEventsApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> CreateEventWithHttpInfo(Object body);
    ...
    public interface IEventsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Object> CreateEventAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> CreateEventWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <param name="body">The data to create an event.</param>
        /// <returns>Object</returns>
        public Object CreateEvent(Object body)
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Object> localVarResponse = CreateEventWithHttpInfo(body);
        ...
        /// <param name="body">The data to create an event.</param>
        /// <returns>ApiResponse of Object</returns>
        public Finbourne.Notifications.Sdk.Client.ApiResponse<Object> CreateEventWithHttpInfo(Object body)
        {
            ...
            var localVarResponse = this.Client.Post<Object>("/api/events", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> CreateEventAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Notifications.Sdk.Client.ApiResponse<Object> localVarResponse = await CreateEventWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Notifications.Sdk.Client.ApiResponse<Object>> CreateEventWithHttpInfoAsync(Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Notifications.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling EventsApi->CreateEvent");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
