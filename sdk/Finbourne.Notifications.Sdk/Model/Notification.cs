...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class Notification : IEquatable<Notification>
    {
        ...
        public Notification(string displayName = default(string), string description = default(string), string deliveryChannel = default(string), Dictionary<string, Object> recipients = default(Dictionary<string, Object>), Dictionary<string, Object> content = default(Dictionary<string, Object>), NotificationStatus status = default(NotificationStatus), DateTimeOffset createdAt = default(DateTimeOffset))
        {
