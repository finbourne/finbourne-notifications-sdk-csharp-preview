...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateAwsSqsNotification")]
    public partial class UpdateAwsSqsNotification : IEquatable<UpdateAwsSqsNotification>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAwsSqsNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateAwsSqsNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAwsSqsNotification" /> class.
        /// </summary>
        ...
        public UpdateAwsSqsNotification(string apiKeyRef = default(string), string apiSecretRef = default(string), string body = default(string), string description = default(string), string queueUrlRef = default(string))
        {
            // to ensure "apiKeyRef" is required (not null)
            this.ApiKeyRef = apiKeyRef ?? throw new ArgumentNullException("apiKeyRef is a required property for UpdateAwsSqsNotification and cannot be null");
            // to ensure "apiSecretRef" is required (not null)
            this.ApiSecretRef = apiSecretRef ?? throw new ArgumentNullException("apiSecretRef is a required property for UpdateAwsSqsNotification and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for UpdateAwsSqsNotification and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for UpdateAwsSqsNotification and cannot be null");
            // to ensure "queueUrlRef" is required (not null)
            this.QueueUrlRef = queueUrlRef ?? throw new ArgumentNullException("queueUrlRef is a required property for UpdateAwsSqsNotification and cannot be null");
        }
        ...
        {
            return this.Equals(input as UpdateAwsSqsNotification);
        }

        /// <summary>
        /// Returns true if UpdateAwsSqsNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAwsSqsNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAwsSqsNotification input)
        {
            if (input == null)
                return false;
