...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class UndeliveredMessage : IEquatable<UndeliveredMessage>
    {
        ...
        /// <param name="deliveryChannel">deliveryChannel (required).</param>
        /// <param name="messageDetails">messageDetails (required).</param>
        /// <param name="deliveryAttempts">deliveryAttempts (required).</param>
