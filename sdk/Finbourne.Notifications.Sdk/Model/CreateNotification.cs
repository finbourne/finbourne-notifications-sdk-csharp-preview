...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class CreateNotification : IEquatable<CreateNotification>
    {
        ...
        public CreateNotification(string notificationId = default(string), string displayName = default(string), string description = default(string), string notificationType = default(string), Object notificationContent = default(Object))
        {
            ...
            this.NotificationContent = notificationContent ?? throw new ArgumentNullException("notificationContent is a required property for CreateNotification and cannot be null");
