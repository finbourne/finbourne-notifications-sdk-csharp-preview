...
namespace Finbourne.Notifications.Sdk.Model
{
    ...
    public partial class SubscriptionDetail : IEquatable<SubscriptionDetail>
    {
        ...
        /// Initializes a new instance of the <see cref="SubscriptionDetail" /> class.
        /// </summary>
        /// <param name="notifications">List of notifications belonging to a subscription.</param>
        ...
        public SubscriptionDetail(List<Notification> notifications = default(List<Notification>), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), string status = default(string), MatchingPattern matchingPattern = default(MatchingPattern), DateTimeOffset createdAt = default(DateTimeOffset), string createdBy = default(string), DateTimeOffset lastModifiedAt = default(DateTimeOffset), string lastModifiedBy = default(string))
        {
            ...
            this.CreatedBy = createdBy ?? throw new ArgumentNullException("createdBy is a required property for SubscriptionDetail and cannot be null");
            this.LastModifiedAt = lastModifiedAt;
            // to ensure "lastModifiedBy" is required (not null)
            this.LastModifiedBy = lastModifiedBy ?? throw new ArgumentNullException("lastModifiedBy is a required property for SubscriptionDetail and cannot be null");
