...
namespace Finbourne.Notifications.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.1.772-4";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.1.772-4/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.1.772-4\n";
            report += "    SDK Package Version: 0.1.772-4\n";
