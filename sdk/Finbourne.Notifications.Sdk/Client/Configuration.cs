...
namespace Finbourne.Notifications.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.1.772-5";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.1.772-5/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.1.772-5\n";
            report += "    SDK Package Version: 0.1.772-5\n";
